...
export default function MonitorPage() {
  ...
  return (
    <AresShell route="monitor" title="로봇 실시간 모니터링" subtitle="ROBOT LIVE MONITORING" compact>
      <main className="grid-2x2">
        <section className="cell gui-cell">
          <PanelHeader title="ROBOT MONITORING" tone="green" action={<span className="alert-chip tiny"><span className="dot" />LIVE</span>} />
          <div className="gui-inner">
            <div className="dash">
              <div className="dash-center">
                <div className="sub-header split"><span><span className="dot green" />MAP · 3F</span></div>
                <div className="map-area">
                  ...
                  <div className="map-overlay-top"><div className="overlay-title">MISSION TIME</div><div className="overlay-val">{formatDuration(missionSeconds)}</div></div>
              ...
              <aside className="dash-right">
                <div className="sub-header"><span className="dot orange-dot" />SURVIVOR</div>
                <div className="sub-body">
                  ...
                  <StatusLine label="ZONES" value="13/20" />
                  <StatusLine label="FIRE" value="306호" />
                  <StatusLine label="UPDATE" value="실시간" />
                  <button className="report-link" type="button" onClick={() => navigate("report")}><i className="ti ti-file-report" /> REPORT</button>
                </div>
              </aside>
            </div>
          </div>
        ...
        <section className="cell status-cell">
          ...
          <div className="status-dashboard">
            ...
            <button className="report-link wide" type="button" onClick={() => navigate("report")}><i className="ti ti-file-report" /> INCIDENT REPORT</button>
          </div>
        </section>

        <CameraPanel title="CAM · ROBOT-01" time={cameraTime} tone="green" />
        <CameraPanel title="CAM · ROBOT-02" time={cameraTime} tone="orange" />
      </main>
    </AresShell>
  );
}
    ...
    <section className="cell cam-cell">
      ...
      <div className="cam-feed">
        <div className="cam-overlay">
          ...
          <div className="cam-no-signal"><span className="big">📷</span>AWAITING FEED<br />{title.replace("CAM · ", "")}</div>
        </div>
        <div className="cam-scanline" />
        <div className={`cam-rec ${tone === "orange" ? "orange-rec" : ""}`}><span className="rec-dot" />REC</div>
